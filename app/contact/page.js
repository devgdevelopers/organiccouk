  ...
  <main className="flex w-full flex-col items-center pt-0 md:pt-[6.5rem] bg-green-light ">
    <section className="container mx-auto mt-0 md:mt-10 my-auto flex flex-col lg:flex-row py-4">
      <div className="rounded-lg p-5 w-[90%] lg:w-[50%] justify-start my-auto mx-auto">
        ...
        <Image src="/contact.png" width={100} height={100} alt="contact-image" className="w-[100%] lg:w-[70%] mx-auto lg:ml-0" unoptimized></Image>
      </div>
      <div className="p-5 w-[100%] lg:w-[40%] mx-auto text-white form-contact-div my-auto">
        <form action="" className="text-white mx-auto p-3 w-[100%] ">
          ...
          <div className="w-[50%] inline">
            ...
            <input type="text" name="" id="Name" className="contact-inputs" required />
          </div>
          <div className="w-[50%] inline">
            <label htmlFor="BusinessName" className="text-green text-base  block mb-3">
              Business Name
            </label>
            <input type="text" name="" id="BusinessName" className="contact-inputs" required />
          </div>
          <div>
            <label htmlFor="EmailAddress" className="text-green text-base  block mb-3">
              Email address
            </label>
            <input type="email" name="" id="EmailAddress" className="contact-inputs" required />
          </div>
          <div>
          ...
          <div>
            ...
            <input type="text" name="" id="helpMsg" className="contact-inputs" required />
          </div>
          <div>
            <span>

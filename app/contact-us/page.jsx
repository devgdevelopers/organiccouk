            ...
            <div>
              ...
              <span>
                ...
                <label
                  ...
                  className="text-sm text-purple font-semibold"
                >
                  We would like to send you occasional news and updates. To join
                  our mailing list, simply select the box below. You can
        ...
        <div className=" mx-auto flex  gap-10 w-[60%]">
          <div className="w-[40%]">
            ...
            <p className="text-justify text-green">
              Tour our facilities and discover how we're transforming waste into
              valuable resources. We look forward to welcoming you and sharing

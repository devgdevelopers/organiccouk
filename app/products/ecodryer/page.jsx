            ...
            <div className="max-w-6xl mx-auto px-4 md:px-6">
              <div className="text-center space-y-4">
                ...
                <p className="text-gray-500 dark:text-gray-400 max-w-xl mx-auto">
                  ...
                  converting the digestate by-product into a quality organic
                  fertiliser.
                </p>
              </div>
            </div>
                ...
                <div>
                  ...
                  <div className="md:mt-14 mt-8">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 mt-4 leading-relaxed text-justify">
                      ...
                      material such as digestate, slurry, farmyard manure,
                      woodchip, sewage, general waste and sludge.
                    </p>
                  </div>
                </div>
              </div>
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-500 dark:text-gray-400 mt-4 leading-relaxed text-justify">
                    ...
                    not only is the digestate being recycled but the heat of the
                    AD system! is utilised in the process. A rotary drum helps
                    granulation of the fertiliser which is sanitised before
                    being continuously discharged from the system. Unlike
                    digestate, this output is biologically inactive and ready
                    for immediate use. The system is highly automated. The
                    feedstock is automatically pumped into the ‘ecoDRYER’
                    producing the fertiliser for collection. Organicco will also
                    offer to buy the fertiliser, adding an additional revenue
                    stream to compliment the biogas production.
                  </p>
                </div>
              </div>
              <div className="space-y-6 md:col-span-2">
                <div>
                  ...
                  <p className="text-gray-500 dark:text-gray-400 my-3 leading-relaxed text-justify ">
                    ...
                    before proposing a solution. Each dryer is unique to suit
                    each customer, and the aim is to provide only the most
                    efficient and quality solutions. Organicco use only the best
                    materials and labour and prides itself on the quality of
                    products. All clients can be sure each system will not only
                    optimise AD plants performance, but will be durable and long
                    lasting. To reflect this Organicco provide competitive
                  ...
                  <p className="text-gray-500 dark:text-gray-400 my-3 leading-relaxed text-justify">
                    ...
                    system size is cost effectively managed.
                  </p>
                  <h2 className="text-2xl md:text-3xl font-bold text-[#2e2e84]">
                    Superior Design
                  </h2>
                  <p className="text-gray-500 dark:text-gray-400 my-3 leading-relaxed text-justify">
                    ...
                    most reputable suppliers and engineers guaranteeing quality,
